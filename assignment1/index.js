...
var unifiedServer = function(req,res){
  ...
  req.on('end', function() {
      ...
      // Should find the hello handler router[hello], which is the "handlers.hello".
      ...
      chosenHandler(data,
        ...
        function(statusCode,payload){
          console.log("Enter chosenHandler");
...
handlers.hello = function(data,callback){
  console.log("Enter handlers.hello");
  callback(200,{'response':'Hello! I am here.'});
};
